...
func (f *fakeGit) Fetch(path, branch string) error                           { return nil }
...
func (f *fakeGit) CurrentBranch(path string) (string, bool, error)           { return "main", false, nil }
func (f *fakeGit) CheckoutBranch(path, branch string) error                  { return nil }
